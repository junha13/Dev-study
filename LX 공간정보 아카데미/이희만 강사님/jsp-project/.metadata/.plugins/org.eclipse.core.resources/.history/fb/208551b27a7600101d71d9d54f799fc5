...
<H2>주소록:작성화면 </H2>
<HR>
[<a href="/myaddrbook/addrbook.do?action=list">주소록 목록으로</a>] <P>
<form name=form1 method=post action="/myaddrbook/addrbook.do">
...
<a href="/25-08-09/logout_control.jsp">logout</a>
